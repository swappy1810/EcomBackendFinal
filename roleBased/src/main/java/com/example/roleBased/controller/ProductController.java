...
//update products from products list
    ...
    public ResponseEntity<Product> updateProduct(@Valid @RequestBody Product product, @PathVariable Integer id){
        ...
        updatedProduct.setProduct_short_desc(product.getProduct_short_desc());
        updatedProduct.setProduct_long_desc(product.getProduct_long_desc());
...
//get product by product id
    ...
    @GetMapping("/recommendation/{catId}/{subCatId}")
        public ResponseEntity<List<Product>> getRelatedProducts(@PathVariable Integer catId,@PathVariable Integer subCatId){
       List<Product> products = productService.getProduct(catId,subCatId);
