...
//get product by product id
    ...
    @GetMapping("/recommend/{prodId}")
    public ResponseEntity<List<Product>> recommendations(@PathVariable Integer prodId){
        return ResponseEntity.ok(productService.findByRecomendations(prodId));
    }
